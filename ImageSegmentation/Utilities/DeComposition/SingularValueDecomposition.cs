...
namespace Utilities
{
    public sealed class SingularValueDecomposition
    {
        ...
        private double DoubleEpsilon = 1.11022302462515654042e-16;
        private double DoubleSmall = 1e-10;
        ...
        {
            get { return DoubleEpsilon * System.Math.Max(m, n) * s[0]; }
        }
            ...
            for (int k = 0; k < mrc; k++)
            {
                if (k < nct)
                {
                    ...
                    for (int i = k; i < a.GetLength(0); i++)
                        s[k] = DoubleArrayExtensions.Hypotenuse(s[k], a[i, k]);
                ...
                if (k < nrt)
                {
                    ...
                    for (int i = k + 1; i < e.GetLength(0); i++)
                        e[k] = DoubleArrayExtensions.Hypotenuse(e[k], e[i]);
                    ...
                    case 1:
                        {
                            ...
                            for (int j = p - 2; j >= k; j--)
                            {
                                Double t = DoubleArrayExtensions.Hypotenuse(s[j], f);
                                Double cs = s[j] / t;
                                Double sn = f / t;
                                s[j] = t;
                                if (j != k)
                    ...
                    case 3:
                        {
                            ...
                            for (int j = k; j < p - 1; j++)
                            {
                                Double t = DoubleArrayExtensions.Hypotenuse(f, g);
                                Double cs = f / t;
                                Double sn = g / t;
                                ...
                                t = DoubleArrayExtensions.Hypotenuse(f, g);
                                cs = f / t;
                                sn = g / t;
                                s[j] = t;
                                f = cs * e[j] + sn * s[j + 1];
        ...
        public Double[,] Solve(Double[,] value)
        {
            ...
            //(V x L*) x Ut x Y
            var VL = DoubleArrayExtensions.Dot(v, Ls);
            ...
            //(V x L* x Ut x Y)
            return DoubleArrayExtensions.Dot(VLU, Y);
        }
        ...
        public Double[,] SolveTranspose(Double[,] value)
        {
            ...
            return DoubleArrayExtensions.Dot(Y, VLU);
        }
        ...
        public Double[,] SolveForDiagonal(Double[] value)
        {
            ...
            //(V x L*) x Ut x Y
            Double[,] VL = DoubleArrayExtensions.Dot(v, Ls);
        ...
        public Double[,] Inverse()
        {
            ...
            var X = new Double[vrows, s.GetLength(0)];
            for (int i = 0; i < vrows; i++)
            {
